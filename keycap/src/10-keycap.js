...
const RGB_TMP=new THREE.Color(), RGB_BASE=new THREE.Color(), GLOW_P=new THREE.Vector3(), GLOW_D=new THREE.Vector3(); let rgbHex=null;   // reused every frame (no garbage)
function applyRGB(t){
